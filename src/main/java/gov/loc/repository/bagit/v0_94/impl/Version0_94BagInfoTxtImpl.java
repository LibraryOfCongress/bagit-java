...
public class Version0_94BagInfoTxtImpl extends gov.loc.repository.bagit.impl.BagInfoTxtImpl implements BagInfoTxt {

	public static final String FIELD_PACKING_DATE = "Packing-Date";
	public static final String FIELD_PACKAGE_SIZE = "Package-Size";
	
	public Version0_94BagInfoTxtImpl(BagFile bagFile, BagConstants bagConstants) {
		super(bagFile, bagConstants);
	}
	
	public Version0_94BagInfoTxtImpl(BagConstants bagConstants) {
		super(bagConstants);
