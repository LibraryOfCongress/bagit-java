...
public class Version0_93BagInfoTxtImpl extends gov.loc.repository.bagit.impl.BagInfoTxtImpl implements BagInfoTxt {

	public static final String FIELD_PACKING_DATE = "Packing-Date";
	public static final String FIELD_PACKAGE_SIZE = "Package-Size";
	
	public Version0_93BagInfoTxtImpl(BagFile bagFile, BagConstants bagConstants) {
		super(bagFile, bagConstants);
	}
	
	public Version0_93BagInfoTxtImpl(BagConstants bagConstants) {
		super(bagConstants);
