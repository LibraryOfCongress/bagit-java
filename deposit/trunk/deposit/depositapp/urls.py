...
urlpatterns = patterns('',
    ...
    #url(r'^user/(?P<username>\w+)/password$', 'django.contrib.auth.views.password_change', {'template_name':'password_change_form.html'}, name="password_url"),
    url(r'^user/(?P<username>\w+)/(?P<command>\w+)$', 'deposit.depositapp.views.user', name="user_command_url"),
